...
import { ICSSCursorRule } from './cursor';
import { SingleAnimation } from './animation';
import { IRawFontStyle } from './raw-font-style';
import { ICSSDisplayRule } from './display';
 ...
 */
export interface IStyle extends IRawFontStyle {
  /**
   ...
   *
   * See CSS align-content property https://www.w3.org/TR/css-flexbox-1/#align-content-property
   *
   */
  alignContent?:
    | ICSSRule
   ...
   *
   * See CSS alignment-adjust property https://www.w3.org/TR/css-text-3/#alignment-prop
   */
   ...
   * See CSS alignment-baseline property https://www.w3.org/TR/css-text-3/#alignment-prop
   */
   ...
   *
   * See CSS animation property https://www.w3.org/TR/css3-animations/#animation-shorthand-property
   *
   */
  animation?: ICSSRule | SingleAnimation | string;
   ...
   */
  color?: ICSSRule | ICSSColorRule | string;
   ...
   * ICSSCursorRule add by me.
   * W3: https://www.w3.org/TR/css-ui-3/#cursor
   */
  cursor?: ICSSRule | ICSSCursorRule | string;
   ...
   * default: ltr
   * W3: https://www.w3.org/TR/css-writing-modes-3/#direction
   */
  direction?: ICSSRule | 'ltr' | 'rtl' | string;
   ...
   * initial: 0 1 auto
   * w3: https://www.w3.org/TR/css-flexbox-1/#flex-property
   */
  ...
  marginBlock?: ICSSRule | 'auto' | string; // margin-block: 10px 20px; /* 绝对长度 */ 一个元素的逻辑块开始和结束边距，根据元素的写入模式、 方向性和文本方向映射到物理边界。
  /**
  ...
  // 可以用来处理如何断开（break lines）带有标点符号的中文、日文或韩文（CJK）文本的行。 auto | loose | normal | strict | anywhere
  lineBreak?: string;
